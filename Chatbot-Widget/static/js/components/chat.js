...
function setBotResponse(response) {
  ...
  setTimeout(() => {
    ...
    if (response.length < 1) {
      ...
      const fallbackMsg = "Imi pare rau, temporar serviciul este indisponibil. Te rog incearca mai tarziu!!!";
      ...
      for (let i = 0; i < response.length; i += 1) {
        ...
        if (Object.hasOwnProperty.call(response[i], "text")) {
          if (response[i].text != null) {
            ...
            // If bot response contains codes
            if (html.includes("COD ROSU")) {
              document.body.style.backgroundColor = "red";
            } else if(html.includes("COD PORTOCALIU")){
              document.body.style.backgroundColor = "orange";
            } else if(html.includes("COD GALBEN")){
              document.body.style.backgroundColor = "yellow";
            } else if(html.includes("COD VERDE")){
              document.body.style.backgroundColor = "green";
            } else if(html.includes("COD ALBASTRU")){
